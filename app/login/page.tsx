...
export default async function Login({searchParams}:{searchParams:Promise<{error?:string}>}){
 ...
 // Records which project and key FORMAT this deployment is configured with. No key material.
 if(error)console.log(JSON.stringify({diagnostic:'auth_config',...authConfigFingerprint()}));
