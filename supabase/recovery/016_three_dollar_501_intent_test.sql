-- Stop execution before recovery. Never reduce the cap below preserved commitments.
begin;
do $$begin
 if (select coalesce(sum(coalesce(actual_usd,reserved_usd)),0) from public.provider_operations)>2 then raise exception 'recovery_cap_below_preserved_commitments';end if;
end $$;
...
update public.workflow_profiles set profile='{"activeIntentTopics":["media & advertising: hubspot (hubs)","media & advertising: hubspot marketing hub","technology: monday.com","search marketing: search engine optimization (seo)","business solutions: corporate website","website publishing: website design","web: replatform website","it management: website performance","crm: customer relationship management (crm)","crm: marketing automation"],"coverage":"Target: 500\u201310,000 employees inclusive. Current provider bands cover 501\u201310,000; exactly-500 companies need a separate verified route.","discoverySetup":{"code":"intent_topics_configured","ready":true,"reason":"Six-topic intent search configured. First multi-topic live outcome remains unmeasured."},"groups":[{"country":"US","language":"en","page":1,"query":"","region":"unspecified","searchDefinition":{"filters":{"business_intent_topics":{"topics":["media & advertising: hubspot (hubs)","media & advertising: hubspot marketing hub","technology: monday.com","search marketing: search engine optimization (seo)","business solutions: corporate website","website publishing: website design","web: replatform website","it management: website performance","crm: customer relationship management (crm)","crm: marketing automation"]},"company_size":{"values":["501-1000","1001-5000","5001-10000"]},"country_code":{"values":["in","us","gb","au","nz","ae","sg"]},"linkedin_category":{"values":["it services and it consulting","construction","advertising services","real estate","hospitals and health care","business consulting and services","operations consulting","software development","consumer services","motor vehicle manufacturing","retail motor vehicles","wholesale motor vehicles and parts","motor vehicle parts manufacturing","education","education management","higher education","education administration programs","primary and secondary education","design services","hospitality"]}},"mode":"full","pageSize":4,"source":"explorium","version":10},"source":"explorium"}],"icp":{"buyerTitles":["CMO","VP Marketing","VP Sales","CEO","Operations","Sales Manager","Sales Head"],"countries":[{"code":"IN","name":"India"},{"code":"US","name":"United States"},{"code":"GB","name":"United Kingdom"},{"code":"AU","name":"Australia"},{"code":"NZ","name":"New Zealand"},{"code":"AE","name":"United Arab Emirates"},{"code":"SG","name":"Singapore"}],"employeeRange":{"max":10000,"min":500},"industries":["IT & Services","Construction","Marketing & Advertising","Real Estate","Healthcare","Consulting","Software","Consumer Services","Automotive","Education","Design","Hospitality"],"intentTopics":["HubSpot","Monday.com","SEO","Website","CRM","Marketing Automation"],"version":10},"maxCandidates":4,"maxResearch":4,"name":"Six-topic intent \u00b7 company research","sendingEnabled":false,"version":10}'::jsonb where id='focused-v1';
update public.budget set limit_usd=2,verification=verification || '{"authorizedCapUsd":2,"recovery":"Restore previous cumulative ceiling; preserve all usage"}'::jsonb where id=1;
...
update public.provider_limits set limit_usd=1.8 where provider='openai';
commit;
