/** Exact user-approved target. Six topic families map through intent-topics; provider classifications remain reported. */
export const intentIcp={
 version:11,employeeRange:{min:501,max:10000},
